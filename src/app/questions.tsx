		...
		<div className="space-y-6 flex flex-col justify-center">
			<div className="flex justify-center">
				<div className="grid grid-cols-5 gap-6 max-w-[1080px] justify-center">
					{options.map((option, index) => {
						...
						return (
							...
							>
								...
								{colorCodes?.[option] && (
									<div
										className={`w-24 h-24 rounded-sm outline outline-2 ${isSelected ? "outline-[var(--bm-white)]" : "outline-slate-900"}`}
					...
					<button
						onClick={onNext}
						className="max-w-fit mt-2 ml-2 px-8 py-3 bg-white text-black rounded-md hover:bg-gray-200 transition-colors text-xl"
					>
						Next
					</button>
				</div>
